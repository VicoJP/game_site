...
<body>
    <header>
        ...
        <nav>
            <form method="get" id="busca" action="index.php">
                Ordenar:
                <a href="javascript:void(0);" onclick="alterarOrdem('ord-nome');" id="ord-nome" class="ordem">Nome <span class="material-icons up">expand_less</span> <span class="material-icons down">expand_more</span><span class="material-icons normal"> unfold_more </span> </a> <!--fazer a ordem de se clicar de novo, inverter-->
                <a href="javascript:void(0);" onclick="alterarOrdem('ord-prod');" id="ord-prod" class="ordem">Produtora <span class="material-icons up">expand_less</span> <span class="material-icons down">expand_more</span><span class="material-icons normal"> unfold_more </span> </a>
                <a href="javascript:void(0);" onclick="alterarOrdem('ord-nota');" id="ord-nota" class="ordem">Nota Alta <span class="material-icons up">expand_less</span> <span class="material-icons down">expand_more</span><span class="material-icons normal"> unfold_more </span> </a>
                <a href="javascript:void(0);" onclick="alterarOrdem('ord-gen');" id="ord-gen" class="ordem">Gênero <span class="material-icons up">expand_less</span> <span class="material-icons down">expand_more</span><span class="material-icons normal"> unfold_more </span> </a>
                <a href="index.php?c=" id="mostrar-todos">Mostrar Todos</a>
    ...
    <div id="corpo">
        ...
        <table class="listagem">
            <?php
            $q = "select j.cod, j.nome, g.genero, j.capa, p.produtora from jogos as j join generos as g on j.genero = g.cod join produtoras as p on j.produtora = p.cod ";
